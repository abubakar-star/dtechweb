...
<body>
  ...
  <div class="amount">Pay <span class="green-text">KES <?php echo $priceNumeric; ?></span></div>
</div>
</div>
      ...
      <button class="pay-button" id="mpesa-pay" disabled>Pay KES <?php echo $priceNumeric; ?></button>
  ...
  <div class="amount">Pay <span class="green-text">KES <?php echo $priceNumeric; ?></span></div>
      ...
      <button class="pay-button" id="till-pay" disabled>Pay KES <?php echo $priceNumeric; ?></button>
  ...
  <div class="amount">Pay <span class="green-text">KES <?php echo $priceNumeric; ?></span></div>
      ...
      <button class="pay-button" id="airtel-pay" disabled>Pay KES <?php echo $priceNumeric; ?></button> 
  </div>
